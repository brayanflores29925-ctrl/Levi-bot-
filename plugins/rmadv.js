...
export default {
  ...
  async execute(sock, m) {
    ...
    if (!target) {
      return await sock.sendMessage(chatId, { text: 'Menciona a la persona a la que quieres quitar una advertencia.' }, { quoted: m })
    }
    ...
    if (db.grupos[chatId].advertencias[target] > 0) {
    ...
    await sock.sendMessage(chatId, {
      text: 'Advertencia quitada. Ahora tiene: ' + cantidad,
      mentions: [target]
    }, { quoted: m })
  }
}
